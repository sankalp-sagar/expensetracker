package com.sankalp.expensetracker.group.config;
...
public class SecurityConfig {
    ...
    @Bean public NewTopic groupCreated() { return new NewTopic(KafkaTopics.GROUP_CREATED, 3, (short) 1); }
    @Bean public NewTopic userInvited() { return new NewTopic(KafkaTopics.USER_INVITED, 3, (short) 1); }
